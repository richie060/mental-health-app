package com.example.mentalhealth.podcast;
...
//                progressDialog.dismiss();
    ...
    public void uploadDetailsToDatabase(String songName, String songUrl, String imageUrl, String artistName, String songDuration){
        ...
        FirebaseDatabase.getInstance().getReference("podcast")
                .push().setValue(song).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Log.i("database", "upload success");
                progressDialog.dismiss();
                Toast.makeText(getApplicationContext(), "Podcast Uploaded to Database", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(UploadPodcastActivity.this, PodcastsActivity.class);
